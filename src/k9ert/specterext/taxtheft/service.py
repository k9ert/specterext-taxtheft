...
class TaxtheftService(Service):
    id = "taxtheft"
    name = "Taxtheft Service"
    icon = "taxtheft/img/ghost.png"
    logo = "taxtheft/img/logo.jpeg"
    desc = "Where a taxtheft grows bigger."
    has_blueprint = True
    blueprint_module = "k9ert.specterext.taxtheft.controller"
